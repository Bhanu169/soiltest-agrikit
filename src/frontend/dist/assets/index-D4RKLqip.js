...
function NavLink({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Link,
    {
      ...
      className: `text-sm font-medium transition-smooth px-3 py-1.5 rounded-lg ${isActive ? "text-primary bg-primary/10" : "text-foreground/70 hover:text-foreground hover:bg-muted"}`,
      children: label
    }
  );
}
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-subtle", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary flex items-center justify-center transition-smooth group-hover:scale-105", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sprout, { className: "w-4 h-4 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-semibold text-lg text-foreground", children: [
              "Agri",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Kit" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { href: link.href, label: link.label }, link.href)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden border-t border-border bg-card px-4 py-3 flex flex-col gap-1 animate-fade-in", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      NavLink,
      {
        href: link.href,
        label: link.label,
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      "data-ocid": "footer",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-primary-foreground/20 border border-primary-foreground/30 flex items-center justify-center transition-smooth group-hover:bg-primary-foreground/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sprout, { className: "w-4 h-4 text-primary-foreground" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl text-primary-foreground", children: "AgriKit." })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/75 leading-relaxed max-w-xs", children: "Soil testing and agriculture support in partnership with YSP University of Horticulture and Forestry." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-display font-semibold text-primary-foreground uppercase tracking-wide", children: "Navigate" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-2", children: FOOTER_NAV.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Link,
              {
                to: link.href,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-display font-semibold text-primary-foreground uppercase tracking-wide", children: "Send Samples To" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm text-primary-foreground/80", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-primary-foreground", children: "Vanshika" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "leading-snug", children: "YSP University of Horticulture and Forestry" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  MapPin,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Nauni, Solan – 173230" })
              ] })
            ] })
          ] })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-primary-foreground/20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-primary-foreground/65", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "© 2026 AgriKit. Rooted in science, grown in care." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Made for the fields of Himachal." })
        ] }) })
      ]
    }
  );
...
const FormStoreContext = reactExports.createContext(
  null
);
function useFormStore() {
  const ctx = reactExports.useContext(FormStoreContext);
  if (!ctx) {
    throw new Error("useFormStore must be used within FormStoreProvider");
  }
  return ctx;
}
function useFormStoreState() {
  const [soilTestingData, setSoilTestingData] = reactExports.useState(defaultSoilTesting);
  const [orderData, setOrderData] = reactExports.useState(defaultOrder);
  const [orderSummary, setOrderSummaryState] = reactExports.useState(
    null
  );
  const updateSoilTesting = reactExports.useCallback(
    (patch) => {
      setSoilTestingData((prev) => ({ ...prev, ...patch }));
    },
    []
  );
  const updateOrder = reactExports.useCallback((patch) => {
    setOrderData((prev) => ({ ...prev, ...patch }));
  }, []);
  const setOrderSummary = reactExports.useCallback((summary) => {
    setOrderSummaryState(summary);
  }, []);
  const resetForms = reactExports.useCallback(() => {
    setSoilTestingData(defaultSoilTesting);
    setOrderData(defaultOrder);
    setOrderSummaryState(null);
  }, []);
  const prefillOrderFromSoilTesting = reactExports.useCallback(() => {
...
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-[60vh]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: "Loading…" })
  ] }) });
}
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(FormStoreContext.Provider, { value: storeValue, children: [
